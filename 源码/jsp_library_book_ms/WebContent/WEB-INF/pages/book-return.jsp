...
<body>
	<div class="book_borrow">
		...
		<form action="bookServlet?method=addToCart&kind=return" method="post">
		<!-- 此处因为没有加method 而造成空指针异常 -->
			<table cellpadding="0" cellspacing="0" border="1px">
				...
				<tr>
					<td colspan="2" style="text-align: center;"><font id="msg" color="red">${requestScope.msg }</font></td>
				</tr>
			</table>
		</form>
		</div>
		<div class="bookCart">
		<form action="bookServlet?method=returnBook" method="post">
			<table  cellpadding="0" cellspacing="0" border="1px">
				<tr>
				...
				<tr>
					<td colspan="7" style="text-align: center;">
						<input type="submit" value="还书" onmousemove="this.className='input_move'" onmouseout="this.className='input_out'" class="input_out"/>&nbsp;&nbsp;<a href="bookServlet?method=clear">清空</a>
					</td>
				</tr>
			</table>
		</form>
